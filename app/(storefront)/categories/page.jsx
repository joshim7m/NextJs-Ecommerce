...
export default async function CategoryListingPage() {
  ...
  const bannerImage = categories.find((c) => c.image)?.image || null;
    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 sm:py-12">
        <div className="relative mb-10 aspect-[3/2] overflow-hidden rounded-2xl bg-slate-200 sm:aspect-[4/1]">
          {bannerImage ? (
            <img src={bannerImage} alt="Categories banner" className="h-full w-full object-cover" />
          ) : (
              ...
              >
                <div className="mb-3 aspect-square w-full overflow-hidden rounded-xl bg-slate-100">
                  {category.image ? (
                    ...
                    <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-[#2f0f6b]/10 to-[#2f0f6b]/5 text-[#2f0f6b] text-2xl font-bold">

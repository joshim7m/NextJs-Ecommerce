        ...
        <div className="rounded-xl border border-violet-200/70 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
          ...
          <form className="mt-4 space-y-4">
            <div>
              ...
              <input type="text" id="name" name="name" required className="mt-1 block w-full rounded-lg border border-violet-300/70 bg-white px-3 py-2 text-sm text-slate-900 placeholder-slate-400 focus:border-[#2f0f6b] focus:outline-none focus:ring-1 focus:ring-[#2f0f6b] dark:border-slate-600 dark:bg-slate-700 dark:text-white dark:placeholder-slate-400 dark:focus:border-[#a78bfa] dark:focus:ring-[#a78bfa]" />
            </div>
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-slate-700 dark:text-slate-300">Email</label>
              <input type="email" id="email" name="email" required className="mt-1 block w-full rounded-lg border border-violet-300/70 bg-white px-3 py-2 text-sm text-slate-900 placeholder-slate-400 focus:border-[#2f0f6b] focus:outline-none focus:ring-1 focus:ring-[#2f0f6b] dark:border-slate-600 dark:bg-slate-700 dark:text-white dark:placeholder-slate-400 dark:focus:border-[#a78bfa] dark:focus:ring-[#a78bfa]" />
            </div>
            <div>
              <label htmlFor="message" className="block text-sm font-medium text-slate-700 dark:text-slate-300">Message</label>
              <textarea id="message" name="message" rows={4} required className="mt-1 block w-full rounded-lg border border-violet-300/70 bg-white px-3 py-2 text-sm text-slate-900 placeholder-slate-400 focus:border-[#2f0f6b] focus:outline-none focus:ring-1 focus:ring-[#2f0f6b] dark:border-slate-600 dark:bg-slate-700 dark:text-white dark:placeholder-slate-400 dark:focus:border-[#a78bfa] dark:focus:ring-[#a78bfa]" />
            </div>

...
/* ─── Main component ─── */
export default function ProductInfo({ product, selectedVariant, variantIndex, onVariantChange }) {
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            <div className="mt-1 flex flex-wrap items-center gap-2">
              ...
              <span className="text-xs text-slate-400 font-mono dark:text-slate-500">SKU: {selectedVariant?.sku || product.sku}</span>
            </div>
          </div>
          <button
            type="button"

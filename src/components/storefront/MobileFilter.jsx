  ...
  const btnClass = (isActive) =>
    `block w-full rounded-lg px-3 py-2 text-left text-sm transition ${
      isActive
        ...
        : 'text-slate-700 hover:bg-violet-100/70 hover:text-[#2f0f6b] dark:text-slate-300 dark:hover:bg-slate-700'
    }`;
                    ...
                    <button
                      ...
                      className={`block w-full rounded-lg px-3 py-1.5 text-left text-sm transition ${
                        selectedCategory === child.slug
                          ? 'bg-[#2f0f6b] text-white dark:bg-[#a78bfa] dark:text-slate-900'
                          : 'text-slate-600 hover:bg-violet-100/70 hover:text-[#2f0f6b] dark:text-slate-400 dark:hover:bg-slate-700'
                      }`}
                    >
                      {child.name}
                    </button>

...
const platforms = {
  ...
  twitter:   { path: 'M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z', color: '#000000' },
    ...
    <footer className="bg-[#1a0a3e] text-slate-300">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-14 border-t border-white/10 pt-8">
          <p className="text-center text-sm text-slate-500">{copyrightText || `© ${currentYear} ${brandName}. All rights reserved.`}</p>
        </div>
      </div>
    </footer>
  );
